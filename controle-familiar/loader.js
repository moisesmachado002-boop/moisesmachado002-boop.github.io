(async () => {
  ...
  const appParts = ["app.01.txt", "app.02.txt", "app.03.txt", "app.04.txt", "app.08.txt", "app.10.txt", "app.05.txt", "app.06.txt", "app.07.txt", "app.09.txt", "app.11.txt", "app.12.txt", "app.13.txt", "app.14.txt"];
