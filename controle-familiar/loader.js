(async () => {
  ...
  const styleParts = ["style.01.txt", "style.02.txt", "style.03.txt", "style.04.txt", "style.05.txt", "style.06.txt", "style.07.txt", "style.08.txt", "style.09.txt", "style.10.txt", "style.11.txt"];
